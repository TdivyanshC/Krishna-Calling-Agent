...
REACT_ABC_INTENTS = {
    ...
    # English phrasing added 2026-08-19 -- confirmed a REAL customer, not a
    # test call, asked "can you call me back" and got no proper response
    # (fell through to a generic fallback that sounded like a bare "okay").
    # This whole category had ZERO English coverage despite being built the
    # same day as the rest of the bilingual system -- every existing phrase
    ...
    # Bare loanword additions 2026-08-19 -- same reasoning as bare
    # "discount"/"मैनेजर" added earlier today: these are specific enough
    # English loanwords (not generic words like "kya") that a customer just
    # saying the word alone ("warranty?", "GST?") is a safe, unambiguous
    # signal, and a real customer very plausibly asks this way -- proactive
    # widening per user request, not waiting for another live-call miss to
